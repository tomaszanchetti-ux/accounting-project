...
1. abrir branch y contexto de `EPIC 06`
2. construir Summary UI sobre la base ya cerrada en `EPIC 05`
3. avanzar card por card hasta dejar el núcleo visible del demo operativo
